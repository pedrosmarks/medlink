-- Script para inserir dados com senhas criptografadas BCrypt para JWT
...
-- =====================================================
-- INSERINDO MÉDICOS COM SENHAS BCRYPT
-- =====================================================
...
-- =====================================================
-- INSERINDO PACIENTES COM SENHAS BCRYPT
-- =====================================================
...
(1, '2024-06-10 10:00:00', 'Paciente apresentou bom estado geral'),
(2, '2024-05-20 14:30:00', 'Controle glicêmico adequado'),
(3, '2024-04-15 09:15:00', 'Recuperação dentro do esperado');
...
-- =====================================================
-- INSERINDO USUÁRIOS PARA AUTENTICAÇÃO COM BCRYPT
-- =====================================================
